...
public class GeometryUtilsTest extends ApplicationTest {
    ...
    public void testBoundingBox() {
        ...
        p2 = new Vector2D(-1,0);
        p3 = new Vector2D(1,-2);
        List<Vector2D> points = new ArrayList<>(Arrays.asList(new Vector2D[]{p1, p2, p3}));
        ...
        p2 = new Vector2D(0,-1);
        p3 = new Vector2D(1,1);
        points = new ArrayList<>(Arrays.asList(new Vector2D[]{p1, p2, p3}));
    ...
    public void testSeparateBoundingBoxes() {
        ...
        assertEquals(true, GeometryUtils.separateBoundingBoxes(boundingBox1, boundingBox2));
    }
}